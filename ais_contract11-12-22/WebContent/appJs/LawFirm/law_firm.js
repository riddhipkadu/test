...
function validateForm() { 
             ...
             var lawf_email_id= $('#lawf_email_id').val();
...
////email validation
          ...
          if(lawf_email_id.length != 0){
        	  var atpos = lawf_email_id.indexOf("@");
              var dotpos = lawf_email_id.lastIndexOf(".");
          if (atpos < 1 || dotpos < (atpos + 2) || (dotpos + 2) >= exte_coun_email_id.length)
          {
              $("#lawf_email_id").attr("data-placement", "top");
              $("#lawf_email_id").attr("data-content", "Please enter valid e-mail address");
