		...
		<div class="col-md-12">
			<div class="col-md-10">
				<div class="header_button">
					...
					<h2 style="color: #032BEC; font-size: 24px; float: left;">Legal Notices</h2>
				...
				<input type="hidden" id="role" value="${sessionScope.sess_user_role}">
					<div class="col-md-4">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select class="form-control" id="lega_noti_entity_id" name="lega_noti_entity_id">
					...
					<div class="col-md-4">
						<div class="form-group">
							<label for="user_dept_id" class="control-label col-sm-4" for="sel1">Function/ Location:</label>
							<div class="col-sm-8">
					 ...
					 <div class="col-md-4">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select class="form-control" name="lega_noti_by_against" id="lega_noti_by_against">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select class="form-control" name="lega_noti_category_id" id="lega_noti_category_id">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<select class="form-control" name="lega_noti_assigned_id" id="lega_noti_assigned_id" >
                    ...
                    <div class="col-md-4">
						<div class="form-group">
							<label class="control-label col-sm-4" for="sel1">Legal notice - From:</label>
							<div class="col-sm-8">
								<div id="from_date_div" class="input-group date" data-date-format="MM">
									<input class="form-control" id="lega_noti_from_date" name="lega_noti_from_date" readonly type="text"><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<div id="to_date_div" class="input-group date" data-date-format="MM">
									<input class="form-control" id="lega_noti_to_date" name="lega_noti_to_date" readonly type="text"> 
					...
					<tbody id="searchResult">
					 <c:forEach items="${listLegalNotice}" var="notice" varStatus="loop">
					    <tr id="row_${notice.lega_noti_id}">
								...
								<td>${notice.lega_noti_status}<br/>
								<c:choose>
								<c:when test="${notice.lega_noti_status != 'Converted'}">
									<a href="./addLitigationByAccept?id=${notice.lega_noti_id}&type=noti">
								     		<button type="button" name='submit' value="submit" style="margin:2px" class="btn btn-success">
											&nbsp;Convert To Litigation</button></a>
								</c:when></c:choose>
								</td> 
								<!-- <td><a href="#" id="document">Document</a></td> -->
								<td>
								<c:choose>
									<c:when test="${sessionScope.sess_user_role==1 || sessionScope.sess_user_role==5 || notice.lega_noti_added_by == sessionScope.sess_user_id}">
										...
										<a
											href="legalNoticeUpdate?lega_noti_id=${notice.lega_noti_id}"><button
