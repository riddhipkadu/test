...
<div class="col-md-10">
				<div class="header_button">
					...
					<h2 style="color:#054eff;font-size:24px;float:left;">Entity List</h2>
					<!-- <a href="./dashboard"><img src="images/DashboardIcons/backold.png" class="backButton" width="100px;"></a> -->
				</div>
				</div>
				<div class="col-md-2">
				<center><a href="./addOrganization" class="btn btn-primary">Add Entity</a></center>
				</div>
			</div>
        ...
        <tbody>
           <c:forEach items="${allOrganizations}" var="organization">
					<tr>
						...
						<td class="edit"><a href="editOrganization?orga_id=${organization[0]}"><button type="button" onclick=""
