...
<div class="page_cont_padd">
	<div class="page_container">
		...
		<!--first form-->
		<sf:form class="form-horizontal" role="form" commandName="editLegalNotice" enctype="multipart/form-data"
					action="./updateLegalNotice"  method="post">
			
			<div class="col-md-10">
				<div class="header_button">
					<!--<button type="button" class="btn btn-primary" id="wdt_re">Litigation Summary</button>-->
					<h2 style="color: #032BEC; font-size: 24px; float: left;">Update Legal	Notice</h2>
			...
			<div class="f_form_content">
				...
				<div class="col-md-12">
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<sf:select class="form-control" path="lega_noti_entity_id" items="${allOrganization}" name="lega_noti_entity_id" id="lega_noti_entity_id">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<sf:select class="form-control" items="${allLocations}" name="lega_noti_unit_id" path="lega_noti_unit_id" id="lega_noti_unit_id">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<sf:select class="form-control" items="${allDepartments}" name="lega_noti_function_id" path="lega_noti_function_id" id="lega_noti_function_id">
								   <option value="0">--Select--</option>
							     </sf:select><i class="asterisk_input"></i>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-7">
								<sf:select class="form-control" name="lega_noti_by_against" path="lega_noti_by_against" id="lega_noti_by_against">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<sf:input type="text" class="form-control" path="lega_noti_opposite_party" id="lega_noti_opposite_party" name="lega_noti_opposite_party"/>
							</div>
						</div>
						<div class="form-group">
					...
					<div class="col-md-6">
					  <div class="form-group">
							<label class="control-label col-sm-5">Notice
								Dated :</label>
							<div class="col-sm-7">
								<div id="noti_date_div" class="input-group date"
									data-date-format="MM">
									<sf:input cssClass="form-control" path="lega_noti_dated" id="lega_noti_dated" name="lega_noti_dated" readonly="true" /> <span
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<sf:select class="form-control" items="${allExternalCounsel}" path="lega_noti_external_counsel_id" id="lega_noti_external_counsel_id">
								    <option value="0" selected="selected">--Select--</option>
				...
				<div class="col-md-12 litigation_buttons">
					<br>
						...
						<center><button type="submit" value="Update" name="Update" class="btn btn-myPrimary">Update</button>
