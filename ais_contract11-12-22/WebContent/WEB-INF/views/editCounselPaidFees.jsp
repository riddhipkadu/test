...
<div class="page_cont_padd">
	<div class="page_container">
		...
		<!--first form-->
		<sf:form class="form-horizontal" role="form" commandName="editPay_counsel" enctype="multipart/form-data" action="./updatePaidCounselFees"  method="POST" onsubmit="return validateForm();">
			
			<div class="col-md-10">
				<div class="header_button">
					<h2 style="color: #032BEC; font-size: 24px; float: left;">Pay Counsel Fees</h2>
			...
			<div class="f_form_content">
				...
				<div class="col-md-12">
					...
					<div class="form-group" style="display:none">
							...
							<div class="col-sm-7">
								<sf:input path="cpaid_counsel_fees_id" cssClass="form-control"/>
							</div>
						</div>
						<div class="form-group" style="display:none">
							<label class="control-label col-sm-5" for="sel1">counsel_fees_id :</label>
							<div class="col-sm-7">
								<sf:input path="cpaid_id" cssClass="form-control"/>
							</div>
						</div>
					...
					<c:when test="${fn:length(CounselPaidFees) != 0}">
						<div class="form-group row">
							<label for="sfctitle" class="control-label col-sm-5">Document Attached :</label>
							<c:forEach items="${CounselPaidFees}" var="document" varStatus="doc">
