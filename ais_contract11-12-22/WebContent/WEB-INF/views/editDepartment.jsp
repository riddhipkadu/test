...
<!--heading text-->
			...
			<div class="col-md-12">
				<div class="header_button">
					...
					<h2 style="color:#054eff;font-size:24px;float:left;">Function/Location</h2>
					<a href="./listDepartments"><img src="images/DashboardIcons/backold.png" class="backButton" width="100px;"></a>
				</div>
			</div>
	<div style="clear:both"></div>
	
	<sf:form commandName="department" method="post" autocomplete="off"
				action="./updateDepartment" cssClass="form-horizontal" onsubmit="return validateForm();">
				...
				<div class="col-md-12">
					<div class="col-md-6" style="display : none;">
						<div class="form-group">
							<label class="control-label col-sm-4" for="sel1">Function Id:</label>
							<div class="col-sm-8">
								<sf:input path="dept_id" cssClass="form-control" />
								<sf:errors path="dept_id" cssClass="errorBlock"></sf:errors>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12">
						<div class="form-group">
							<label class="control-label col-sm-4" for="sel1">Function/Location:</label>
							<div class="col-sm-5">
								<sf:input path="dept_name" cssClass="form-control" /><i class="asterisk_input"></i>
								<sf:errors path="dept_name" cssClass="errorBlock"></sf:errors>
							</div>
						</div>
						<div class="form-group">
							  <label class="control-label col-sm-4" for="sel1">Function/Location Short Name:</label>
							  <div class="col-sm-5">
...
$("#dept_name").keyup(function(){ 
	//$('#dept_name').val($.trim($('#dept_name').val()));
...
$("#dept_short_name").keyup(function(){ 
	//$('#dept_short_name').val($.trim($('#dept_short_name').val()));
