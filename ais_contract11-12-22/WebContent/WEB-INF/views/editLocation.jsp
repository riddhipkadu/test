...
<!--heading text-->
			...
			<div class="col-md-12">
				<div class="header_button">
					...
					<h2 style="color:#054eff;font-size:24px;float:left;">Unit/Vertical</h2>
					<a href="./listLocations"><img src="images/DashboardIcons/backold.png" class="backButton" width="100px;"></a>
				</div>
			</div>
	<div style="clear:both"></div>
	
	<sf:form commandName="location" autocomplete="off" cssClass="form-horizontal" method="post" 
				action="./updateLocation"  onsubmit="return validateForm();">
				...
				<div class="col-md-12">
					<div class="col-md-6" style="display : none;">
						<div class="form-group">
							<label class="control-label col-sm-4" for="sel1">Unit Id:</label>
							<div class="col-sm-8">
								<sf:input path="loca_id" cssClass="form-control" />
								<sf:errors path="loca_id" cssClass="errorBlock"></sf:errors>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<div class="col-sm-5">
								<sf:input path="loca_name" cssClass="form-control" /><i class="asterisk_input"></i>
					...
					<div class="col-md-12">
						<div class="form-group">
							<label class="control-label col-sm-4" for="sel1">Unit/Vertical short name:</label>
							<div class="col-sm-5">
								<sf:input path="loca_short_name" cssClass="form-control" /><i class="asterisk_input"></i>
...
<script type="text/javascript">
 ...
 $("#loca_name").keyup(function(){ 
	// $('#loca_name').val($.trim($('#loca_name').val()));
 ...
 $("#loca_short_name").keyup(function(){ 
	 //$('#loca_short_name').val($.trim($('#loca_short_name').val()));
