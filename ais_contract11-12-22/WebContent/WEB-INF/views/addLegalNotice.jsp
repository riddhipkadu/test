...
<div class="page_cont_padd">
	<div class="page_container">
		...
		<!--first form-->
		<sf:form class="form-horizontal" role="form" commandName="addLegalNotice" enctype="multipart/form-data"
			...
			<div class="col-md-10">
				<div class="header_button">
					...
					<h2 style="color: #032BEC; font-size: 24px; float: left;">New Legal	Notice</h2>
				...
				<div class="col-md-12">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<sf:select class="form-control" name="lega_noti_unit_id" path="lega_noti_unit_id" id="lega_noti_unit_id">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<sf:select class="form-control" name="lega_noti_function_id" path="lega_noti_function_id" id="lega_noti_function_id">
								   <option value="0">--Select--</option>
							     </sf:select><i class="asterisk_input"></i>
							</div>
						</div>
