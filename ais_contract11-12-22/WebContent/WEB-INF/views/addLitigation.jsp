...
<div class="page_cont_padd">
	<div class="page_container">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="header_button">
						...
						<h2 style="color: #032BEC; font-size: 24px; float: left;">Add
							Litigations</h2>
			...
			<!-- End Header -->
			<sf:form class="form-horizontal" commandName="litigation" action="./saveLititgation" method="POST">
					...
					<div class="col-md-12" style="margin-top: 10px;">
						...
						<div class="col-md-8">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<sf:textarea path="liti_brief_description" placeholder="Brief Description" cssClass="form-control" rows="2" cols="57" />
								</div>
							</div>
						</div>
					</div>
