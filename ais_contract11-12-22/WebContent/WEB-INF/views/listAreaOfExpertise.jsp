...
<div class="col-md-10">
				<div class="header_button">
					...
					<h2 style="color:#054eff;font-size:24px;float:left;">Area Of Expertise List</h2>
					<a href="./masters"><img src="images/DashboardIcons/backold.png" class="backButton" width="100px;"></a>

				</div>
				</div>
				<div class="col-md-2">
				<center><a href="./addAreaOfExpertise" class="btn btn-primary">Add Area Of Expertise</a></center>
				</div>
			</div>
	...
	<!--first form-->
        ...
        <tbody>
          <c:forEach items="${listAreaOfExpertise}" var="expertise" varStatus="loop">
					<tr id="row_${expertise.area_expe_id}">
						<td>${loop.index+1}</td>
						<td>${expertise.area_expe_name}</td>
						<td class="edit"><a href="editAreaOfExpertise?area_expe_id=${expertise.area_expe_id}"><button type="button" onclick=""
							name='submit' value="submit" class="btn btn-primary">
							<i class='fa fa-pencil-square-o'></i>&nbsp;Edit
						</button></a></td>
						
						<td class="delete"><button type="button" value="${expertise.area_expe_id}"
											 name='delete_area_expe' 
