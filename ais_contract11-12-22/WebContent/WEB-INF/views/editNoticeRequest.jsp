...
<div class="page_cont_padd">
	<div class="page_container">
		<div class="container">
			...
			<!-- End Header -->
			<sf:form class="form-horizontal" commandName="editNoticeRequest" action="./updateNoticeRequest" enctype="multipart/form-data" method="POST">
				...
				<!-- Second Panel -->
					 ...
					 <div class="col-md-12" style="margin-top: 10px;">
						...
						<div class="col-md-4" style="display:none">
							<div class="form-group" >
								...
								<div class="col-sm-8">
									<sf:input path="req_noti_id" id="req_noti_id" />
								</div>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<sf:select class="form-control" path="req_noti_entity_id" id="req_noti_entity_id">
					...
					<div class="col-md-12" style="margin-top: 10px;">
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<sf:select class="form-control" path="req_noti_unit_id" id="req_noti_unit_id">
					...
					<div class="col-md-12" style="margin-top: 10px;">
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<sf:select class="form-control" path="req_noti_function_id" id="req_noti_function_id">
						...
						<div class="col-md-8">
							<div class="form-group">
								<label class="control-label col-sm-4" for="sel1">Notice Type:</label>
								 <div class="col-sm-8">
									<sf:select id="req_noti_type_by_against" path="req_noti_type_by_against" class="form-control">
										<option value="0">--Select--</option>
										<sf:option value="By">Notice Given</sf:option>
										<!-- By -->
										<sf:option value="Against">Notice Received</sf:option>
										<!-- Against -->
									</sf:select><i class="asterisk_input"></i>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<div class="input-group date" id="datepicker1"
										data-date-format="MM">
										<sf:input id="req_noti_date" path="req_noti_date" class="form-control" readonly="true"/><span
				 	...
				 	<div class="col-md-12" style="margin-top: 10px;">
						<div class="col-md-8">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<sf:input id="req_noti_oppo_party" path="req_noti_oppo_party" class="form-control"
					...
					<div class="col-md-12" style="margin-top: 10px;">
						<div class="col-md-8">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<sf:textarea id="req_noti_des" path="req_noti_des" rows="4" cols="59" ></sf:textarea>
								</div>
							</div>
						</div>
					</div>
