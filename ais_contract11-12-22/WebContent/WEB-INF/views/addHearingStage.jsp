...
<div class="page_cont_padd">
	<div class="page_container">
		...
		<!--first form-->
		<sf:form class="form-horizontal" role="form" enctype="multipart/form-data" commandName="addHearingStage"
			...
			<div class="f_form_content">
				...
				<div class="col-md-12">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<div id="third_alert_div" class="input-group date"
									data-date-format="MM">
									<sf:input class="form-control" path="ttrn_third_alert" id="ttrn_third_alert" name="ttrn_third_alert" readonly="true" disabled="true"/><span
					...
					<div class="col-md-6">
					 ...
					 <div class="form-group">
							<label class="control-label col-sm-5" for="sel1">Advocate/Law Firm :</label>
							<div class="col-sm-7">
