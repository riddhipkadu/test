...
<div class="page_cont_padd">
	<div class="page_container">
		...
		<!--first form-->
		<sf:form class="form-horizontal" role="form" enctype="multipart/form-data" commandName="editHearingStage"
					action="./updateHearingStage" method="post">
			
			<div class="col-md-10">
				<div class="header_button">
					<!--<button type="button" class="btn btn-primary" id="wdt_re">Litigation Summary</button>-->
					<h2 style="color: #032BEC; font-size: 24px; float: left;">Edit Hearing Stage</h2>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<div id="third_alert_div" class="input-group date"
									data-date-format="MM">
									<sf:input class="form-control" path="ttrn_third_alert" id="ttrn_third_alert" name="ttrn_third_alert" readonly="true" /> <span
										class="input-group-addon"><i
										class="glyphicon glyphicon-calendar"></i></span>
								</div>
							</div>
