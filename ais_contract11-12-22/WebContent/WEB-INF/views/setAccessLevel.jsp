	...
	<div class="page_container">
		...
		<div class="col-md-12">
			<div class="header_button">
				...
				<h2 style="color: #054eff; font-size: 24px; float: left;">Set
					Access Level</h2>
...
<script>
	...
	function validateAccess() {
		/* var uname = $('#user_user_id').val();
		if (uname == 0) {

			$("#user_user_id").attr("data-placement", "top");
			$("#user_user_id").attr("data-content", " Select User Name ");
			$('#user_user_id').popover('show');

			return false;
		}

		else {
			$('#user_user_id').popover('destroy');
		} */
