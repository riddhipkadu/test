...
<div class="page_cont_padd">
	<div class="page_container">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="header_button">
						...
						<h2 style="color: #032BEC; font-size: 24px; float: left;">Edit Litigations</h2>
			...
			<!-- End Header -->
			<sf:form class="form-horizontal" commandName="editLitigation" action="./updateLitigation" method="post">
				<!-- First Panel -->
					...
					<div class="col-md-4" style="display:none">
							<div class="form-group">
								<label class="control-label col-sm-4" for="sel1">
									: </label>
								<div class="col-sm-8">
									<sf:input path="liti_id" /><i class="asterisk_input"></i>
								</div>
							</div>
						</div>
						<div class="col-md-4">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<sf:select path="liti_loca_id" items="${allLocations}" cssClass="form-control">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<sf:select path="liti_dept_id" items="${allDepartments}" cssClass="form-control">
										<sf:option value="0">--Select--</sf:option>
									</sf:select><i class="asterisk_input"></i>
								</div>
							</div>
						...
						<div class="col-md-8">
							<div class="form-group">
								<label class="control-label col-sm-4" for="sel1">
									By Party(s) : </label>
								<div class="col-sm-8">
									<sf:input path="liti_party_by" name="liti_party_by" class="form-control"
						...
						<div class="col-md-8">
							<div class="form-group">
								<label class="control-label col-sm-4" for="sel1"> Against
									Party(s): </label>
								<div class="col-sm-8">
									<sf:input path="liti_party_against" name="liti_party_against" class="form-control"
 ...
 --%>
					...
					<div class="col-md-8">
						 <div class="form-group">
							...
							<div class="col-sm-8">
									<sf:select class="validate[required]" path="liti_advocate_law_firm"
					...
					<div class="col-md-12" style="margin-top: 10px;">
						<div class="col-md-8">
							<div class="form-group">
								<label class="control-label col-sm-4">Limitation Date :</label>
								<div class="col-sm-8">
									<div class="input-group date" id="datepicker1"
										data-date-format="MM">
										<sf:input path="liti_case_filing_date" cssClass="form-control" readonly="true"/><span
				...
				<div class="f_form_content">
					...
					<div class="col-md-12" style="margin-top: 10px;">
						<div class="col-md-8">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input id="esc_appear_counsel" name="esc_appear_counsel" value="${counsel_appear }"
					...
					<div class="col-md-12" style="margin-top: 10px;">
					<div class="form-group">
					<p style="text-align: center;">(Note: Please enter atmost six email id separated by comma for each of above four fields.)</p>
					</div>
					</div>
				</div>
					...
					<div class="col-md-12" style="margin-top: 10px;">
						<div class="col-md-8">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<sf:input path="liti_opposite_party_advocate"
										cssClass="form-control" placeholder="Advocate name" /><i class="asterisk_input"></i>
						...
						<div class="col-md-8">
							<div class="form-group">
								<label class="control-label col-sm-4" for="sel1">Relevant
									Law: </label>
								<div class="col-sm-8">
									<sf:textarea path="liti_relevant_law" cssClass="form-control" rows="4" cols="60"
					...
					<div class="col-md-12" style="margin-top: 10px;">
						<div class="col-md-8">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<sf:textarea path="liti_brief_description" cssClass="form-control" rows="4" cols="60" />
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<div class="input-group date" id="liti_amount_div"
												data-date-format="MM">
												<input class="form-control" id="liti_conversion_date" readonly="true"/><span
													class="input-group-addon"><i
													class="glyphicon glyphicon-calendar"></i></span>
...
$(document).ready(function(){
	...
	$.ajax({
		...
		success: function (result) {
			...
			$("#liti_previous_liti_ref_no").val('${previous_liti_no}');
	...
	var criti = "${criticality}";
	 ...
	 //setTimeout(function(){ 
		 ...
		 var liti_amount_involved = $("#liti_amount_involved").val();
		   $("#liti_converted_amt").val(liti_amount_involved*liti_conversion_rate);
		 //}, 1000);
