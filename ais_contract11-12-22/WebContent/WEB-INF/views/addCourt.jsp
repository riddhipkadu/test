...
<!--heading text-->
			...
			<div class="col-md-12">
				<div class="header_button">
					...
					<h2 style="color:#054eff;font-size:24px;float:left;">Court</h2>
					<a href="./listCourt"><img src="images/DashboardIcons/backold.png" class="backButton" width="100px;"></a>
				</div>
			</div>
	<div style="clear:both"></div>
	<!--first form-->
	<sf:form commandName="addCourt" autocomplete="off" cssClass="form-horizontal" 
				action="./saveCourt" onsubmit="return validateForm();" >
				...
				<div class="col-md-12">
						...
						<div class="form-group">
							  <label class="control-label col-sm-4" for="sel1">Court:</label>
								<div class="col-sm-5">
							  <sf:input type="text" path="court_name" cssClass="form-control" onkeypress="return blockSpecialChar(event);" /><i class="asterisk_input"></i>
