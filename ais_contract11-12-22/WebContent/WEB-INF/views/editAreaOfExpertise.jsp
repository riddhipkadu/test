...
<!--heading text-->
			...
			<div class="col-md-12">
				<div class="header_button">
					...
					<h2 style="color:#054eff;font-size:24px;float:left;">Area Of Expertise</h2>
					<a href="./listAreaOfExpertise"><img src="images/DashboardIcons/backold.png" class="backButton" width="100px;"></a>
				</div>
			</div>
	<div style="clear:both"></div>
	
	<sf:form commandName="editAreaOfExpertise" autocomplete="off" cssClass="form-horizontal" method="post" 
				...
				<div class="col-md-12">
					<div class="col-md-6" style="display : none;">
						<div class="form-group">
							<label class="control-label col-sm-4" for="sel1">Area Of Expertise Id:</label>
							<div class="col-sm-8">
