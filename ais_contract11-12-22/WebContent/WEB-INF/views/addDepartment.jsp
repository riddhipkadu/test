...
<!--heading text-->
			...
			<div class="col-md-12">
				<div class="header_button">
					...
					<h2 style="color:#054eff;font-size:24px;float:left;">Department</h2>
			...
			<h2>Create Function</h2>
				<div class="col-md-12">
						<div class="form-group">
							  <label class="control-label col-sm-4" for="sel1">Department:</label>
							  <div class="col-sm-5">
						...
						<div class="form-group">
							  <label class="control-label col-sm-4" for="sel1"> Short Name:</label>
							  <div class="col-sm-5">
