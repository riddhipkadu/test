		...
		<!--first form-->
			...
			<div class="col-md-10">
				<div class="header_button">
					...
					<a href="./updateTab?cont_id=${contid}"><img src="images/DashboardIcons/backold.png" class="backButton" width="100px;"></a>
					<h2 style="color: #054eff; font-size: 24px; float: left;">Edit Contract History</h2>
					<!--  <a href="./updateTab?cont_id=1"><img src="images/DashboardIcons/backold.png" class="backButton" width="100px;"></a>  -->
				</div>
			</div>
