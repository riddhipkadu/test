					...
					<div class="col-md-12">
						<div class="col-md-4">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<sf:select path="liti_orga_id" cssClass="form-control" disabled="true">										
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<sf:select path="liti_loca_id"  cssClass="form-control" disabled="true">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<sf:select path="liti_dept_id"  cssClass="form-control" disabled="true">
