...
<div class="page_cont_padd">
	<div class="page_container">
		...
		<sf:form Class="form-horizontal" role="form" commandName="addTermRen"
			action="./saveTermRenContract" method="POST" enctype="multipart/form-data">

			<div class="col-md-10">
				<div class="header_button">
					<!--<button type="button" class="btn btn-primary" id="wdt_re">Litigation Summary</button>-->
					<h2 style="color: #054eff; font-size: 24px; float: left;">Add
			...
			<div class="f_form_content">
				...
				<div class="col-md-12">
					...
					<div class="col-md-6">
						<div class="form-group" style="display: none;">
							<label for="sfctitle" class="control-label col-sm-5">contract
								id :</label>
							<div class="col-sm-7">
								<input id="termren_exec_contract_id"
									name="termren_exec_contract_id"
					...
					<div class="col-md-6">
						<div class="form-group" id="from_date_div1" style="margin-top: 10px;  display: none">
						...
						<div class="form-group" id="to_date_div1" style="margin-top: 10px;  display: none">
...
<script>
	...
	$("#termren_contract_status").on('change', function(){
		if($(this).val() == 'Contract Renewal'){
			$("#to_date_div1").show();
		}else{
			$("#to_date_div1").hide();
		}
