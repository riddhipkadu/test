...
<div class="col-md-10">
				<div class="header_button">
					...
					<h2 style="color:#032BEC;font-size:24px;float:left;">Litigation Type List</h2>
	...
	<!--first form-->
        ...
        <tbody>
           <c:forEach items="${list_litigation}" var="litigation" varStatus="loop">
					<tr id="row_${litigation.liti_type_id}">
						<td>${loop.index+1}</td>
						<td>${litigation.liti_type_name}</td>
						<td class="edit"><a href="editLitiType?liti_id=${litigation.liti_type_id}"><button type="button" onclick=""
