	...
	<div class="page_container">
		...
		<div class="col-md-12">
			<div class="header_button">
				...
				<h2 style="color: #054eff; font-size: 24px; float: left;">Entity</h2>
				<a href="./listOrganizations"><img src="images/DashboardIcons/backold.png" class="backButton" width="100px;"></a>
			</div>
		</div>
		<div style="clear: both"></div>
		<!--first form-->
		<sf:form commandName="organization" autocomplete="off" cssClass="form-horizontal" onsubmit="return validateForm();"
			...
			<div class="f_form_content">
				...
				<!-- <div class="col-md-12"> -->
					...
					<div class="col-md-12">
						<div class="form-group">
							<label class="control-label col-sm-3" for="sel1">Short name for entity:</label>
							<div class="col-sm-7">
								<sf:input path="orga_short_name" id='orga_short_name' name="orga_short_name"
									cssClass="form-control" /><i class="asterisk_input"></i>
...
$("#orga_name").keyup(function(){ 
	//$('#orga_name').val($.trim($('#orga_name').val()));
...
$("#orga_short_name").keyup(function(){ 
	//$('#orga_short_name').val($.trim($('#orga_short_name').val()));
      ...
      function validateForm() {
    	 // alert("!!!!!!");
			...
			if ($('#orga_parent_id').val() == 0 || $('#orga_parent_id').val() == "") {
                 ...
                 $( "#orga_parent_id" ).attr( "data-content", "Parent Entity name required" );
