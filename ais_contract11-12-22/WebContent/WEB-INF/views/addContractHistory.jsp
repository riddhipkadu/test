		...
		<!--first form-->
			<div class="col-md-10">
				<div class="header_button">
					...
					<h2 style="color: #054eff; font-size: 24px; float: left;">Add Contract History</h2>
...
<sf:form class="form-horizontal" role="form" enctype="multipart/form-data"  commandName="contractHistory" action="./saveContractHistory" method="post">
 <input type="hidden" name="actionType" id="actionType"/>
				...
				<div class="col-md-12 litigation_buttons">
					<br>
						<center>
						<button type="submit" name="Save" value="Save" id="Save" class="btn btn-success">Create</button>
