			...
			<div id="myTabContent" class="tab-content">
				...
				<div class="tab-pane fade active in" id="details">
					<div class="col-md-12" style="margin-top: 20px;">
						...
						<div style="clear: both"></div>
						<c:choose>
						<c:when test="${legalNoticeDetails.lega_noti_status == 'Converted' }">
						<div class="col-md-12 light">
							<div class="col-md-2">
								<label>Litigation Reference Number :</label>
							</div>
							<div class="col-md-10">
								<span><a href="litigationDetails?liti_id=${liti_id }" style="color: blue;">${legalNoticeDetails.lega_noti_liti_ref_id }</a></span>
							</div>
						</div>
						</c:when>
						</c:choose>
						...
						<div class="col-md-12 dark">
							...
							<div class="col-md-10">
								<span>${legalNoticeDetails.lega_noti_amount_involved }  ${legalNoticeDetails.lega_noti_involved_amt_currency }</span>
							</div>
						</div>
						<div class="col-md-12 light">
							<div class="col-md-2">
						...
						<div class="col-md-12 light">
							<div class="col-md-2">
								<label>Notice assigned to:</label>
							</div>
							<div class="col-md-10">
							...
							<tbody>
								...
								<c:forEach items="${legalNoticeDocuments}" var="document"
									...
									<tr id="row_${document.lega_doc_id}">
										...
										<td><button type="button" value="${document.lega_doc_id}" name='delete_legal_notice_status_doc' 
					...
					<div class="col-md-12" style="margin-top: 20px;">
                          ...
                          <table id="example" class="table table-striped table-bordered" width="100%" cellspacing="0">
							...
							<tbody>
								...
								<c:forEach items="${legalNoticeStatus}" var="status" varStatus="loop">
									<tr id="row_${status.lega_status_id}">
										...
										<td>
  											<c:forEach items="${status.lega_documents }" var="status_doc">
  											<a href="./downloadLegalNoticeDoc?lega_doc_id=${status_doc.lega_doc_id}">
  											   ${status_doc.lega_doc_original_file_name } </a><br>
  											</c:forEach>
                                        </td>
										<td>
										    <c:choose>
												<c:when	test="${sessionScope.sess_user_role==1 || status.lega_status_added_by == sessionScope.sess_user_id}">
													<a href="editLegalNoticeStatus?lega_noti_status_id=${status.lega_status_id}">
												<button	type="button" name='submit' value="submit"
													class="btn btn-primary btn-block" style="margin-bottom :4px">
													<i class='fa fa-pencil-square-o'></i>&nbsp;Edit
												</button></a>
												<button type="button" value="${status.lega_status_id}" name='delete_legal_notice_status' 
