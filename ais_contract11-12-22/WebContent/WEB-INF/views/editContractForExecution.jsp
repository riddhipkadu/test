	...
	<div class="page_container">
		...
		<div class="col-md-12">
			<div class="header_button">
				...
				<h2 style="color: #054eff; font-size: 24px; float: left;">Edit Contract</h2>
		...
		<sf:form commandName="editContract" action="./updateContract" enctype="multipart/form-data" cssClass="form-horizontal">
			...
			<div class="f_form_content">
				...
				<div class="col-md-6">
						<div class="form-group">
							<label class="control-label col-sm-4" for="sel1">Effective date:</label>
							<div class="col-sm-8">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label class="control-label col-sm-4" for="sel1">Expiry date:</label>
							<div class="col-sm-8">
				...
				<div class="col-md-6">
						<div class="form-group">
							<label class="control-label col-sm-4" for="sel1">Type of Agreement :</label>
							<div class="col-sm-8">
							
							<sf:select  path ="cont_type_of_contract" cssClass="form-control">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label class="control-label col-sm-4" for="sel1"> Payment clause:</label>
							<div class="col-sm-8">
				...
				<div class="col-md-12">
					<div class="col-md-6">
						<div class="form-group">
							<label class="control-label col-sm-4" for="sel1">Targeted Date:</label>
							<div class="col-sm-8">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label class="control-label col-sm-4" for="sel1">Reminder Date:</label>
							<div class="col-sm-8">
				...
				<div class="col-md-12">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label class="control-label col-sm-4" for="sel1"> Term Period of the Agreement (In months):</label>
							<div class="col-sm-8">
								<sf:textarea rows="3" cols="47" path="cont_term" id="cont_term" name="cont_term"></sf:textarea>
							</div>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<sf:textarea rows="3" cols="47" path="cont_nature" id="cont_nature" name="cont_nature"></sf:textarea>
							</div>
						</div>
					</div>
				...
				<div class="col-md-12">
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<sf:textarea rows="3" cols="47" path="cont_surviving_clause" id="cont_surviving_clause" name="cont_surviving_clause"></sf:textarea>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<sf:textarea rows="3" cols="47" path="cont_major_clause" id="cont_major_clause" name="cont_major_clause"></sf:textarea>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-12">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label class="control-label col-sm-4" for="sel1">Indemnity Clause :</label>
							<div class="col-sm-8">
								<sf:textarea rows="3" cols="47" path="cont_damages" id="cont_damages" name="cont_damages" placeholder="Enter Indemnity Clause"></sf:textarea>
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<sf:textarea rows="3" cols="47" path="cont_instructions" placeholder="Enter Instructions"></sf:textarea>
							</div>
						</div>
					</div>
				</div>
