...
<div class="page_cont_padd">
	<div class="page_container">
		...
		<!--first form-->
		<sf:form class="form-horizontal" role="form" commandName="addAdvocate"  onsubmit="return validateForm();"
					action="./saveAdvocate"  method="POST">
			
			<div class="col-md-10">
				<div class="header_button">
					<!--<button type="button" class="btn btn-primary" id="wdt_re">Litigation Summary</button>-->
					<h2 style="color: #032BEC; font-size: 24px; float: left;">Advocate</h2>
				...
				<div class="col-md-12">
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<sf:select class="form-control" path="advo_state_id" id="advo_state_id" name="advo_state_id">
								    <sf:option value="0">--Select--</sf:option>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<sf:select class="form-control"  path="advo_city_id" id="advo_city_id" name="advo_city_id">
								    <sf:option value="0">--Select--</sf:option>
