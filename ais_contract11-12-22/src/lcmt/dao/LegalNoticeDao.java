...
public interface LegalNoticeDao {
     ...
     public List<Object> searchLegalNotice(int lega_noti_entity_id, int lega_noti_unit_id, int lega_noti_function_id, String lega_noti_by_against, int lega_noti_category_id, int lega_noti_assigned_to_id, String scau_notice_from_date, String scau_notice_to_date,HttpSession session);
