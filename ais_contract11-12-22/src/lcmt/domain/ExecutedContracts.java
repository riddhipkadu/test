...
public class ExecutedContracts {
	...
	private Date exec_contract_execution_date;
	private Date exec_contract_renewal_date;
	...
	private Date exec_remind_date;
	private Date exec_remind_date_second;
	private Date exec_remind_date_third;
	private String exec_contract_status;
	@Size(max = 64000)
	...
	public Date getExec_remind_date_second() {
		return exec_remind_date_second;
	}
	public void setExec_remind_date_second(Date exec_remind_date_second) {
		this.exec_remind_date_second = exec_remind_date_second;
	}
	public Date getExec_remind_date_third() {
		return exec_remind_date_third;
	}
	public void setExec_remind_date_third(Date exec_remind_date_third) {
		this.exec_remind_date_third = exec_remind_date_third;
	}
	public Date getExec_remind_date() {
		return exec_remind_date;
	}
	public void setExec_remind_date(Date exec_remind_date) {
	...
	public Date getExec_contract_execution_date() {
		return exec_contract_execution_date;
	}
	public void setExec_contract_execution_date(Date exec_contract_execution_date) {
		this.exec_contract_execution_date = exec_contract_execution_date;
	}
	public Date getExec_contract_renewal_date() {
		return exec_contract_renewal_date;
	}
	public void setExec_contract_renewal_date(Date exec_contract_renewal_date) {
	...
	public void setExec_contract_start_date(Date date) {
		this.exec_contract_start_date = date;
	}
	...
	public String getExec_contract_status() {
		return exec_contract_status;
	}
	public void setExec_contract_status(String exec_contract_status) {
		this.exec_contract_status = exec_contract_status;
	}
