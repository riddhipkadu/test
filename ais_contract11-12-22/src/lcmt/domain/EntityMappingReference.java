...
public class EntityMappingReference {

	private int enti_id;
	private int enti_orga_id;
	private int enti_loca_id;
	private ArrayList<Integer> enti_dept_id;
	...
	public ArrayList<Integer> getEnti_dept_id() {
		return enti_dept_id;
	}
	public void setEnti_dept_id(ArrayList<Integer> enti_dept_id) {
