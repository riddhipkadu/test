...
public class ContractReference {
	...
	private String cont_reminder_date;
	private Date cont_start_date_name;
	private Date cont_end_date_name;
	private Date cont_reminder_date_name;
	private int chst_poc_user_id;
	private int cont_req_id;
	private String cont_type_of_contract;
	private String cont_force_majeure;
	public String getCont_division() {
		return cont_division;
	}
	public void setCont_division(String cont_division) {
		this.cont_division = cont_division;
	}
	...
	public String getCont_reminder_date() {
		return cont_reminder_date;
	}
	public void setCont_reminder_date(String cont_reminder_date) {
		this.cont_reminder_date = cont_reminder_date;
	}
	public Date getCont_start_date_name() {
		return cont_start_date_name;
	}
	public void setCont_start_date_name(Date cont_start_date_name) {
		this.cont_start_date_name = cont_start_date_name;
	}
	public Date getCont_end_date_name() {
		return cont_end_date_name;
	}
	public void setCont_end_date_name(Date cont_end_date_name) {
		this.cont_end_date_name = cont_end_date_name;
	}
	public Date getCont_reminder_date_name() {
		return cont_reminder_date_name;
	}
	public void setCont_reminder_date_name(Date cont_reminder_date_name) {
	...
	public String getCont_type_of_contract() {
		return cont_type_of_contract;
	}
	public void setCont_type_of_contract(String cont_type_of_contract) {
		this.cont_type_of_contract = cont_type_of_contract;
	}
	public String getCont_force_majeure() {
		return cont_force_majeure;
	}
	public void setCont_force_majeure(String cont_force_majeure) {
		this.cont_force_majeure = cont_force_majeure;
	}
