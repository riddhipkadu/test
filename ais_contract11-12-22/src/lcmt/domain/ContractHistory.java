...
@Entity(name = "trn_contract_history")
public class ContractHistory {
	...
	private int chst_assigned_to;
	private Date chst_received_date; 
	...
	public Date getChst_received_date() {
		return chst_received_date;
	}
	public void setChst_received_date(Date chst_received_date ) {
	...
	public int getChst_assigned_to() {
		return chst_assigned_to;
	}
	public void setChst_assigned_to(int chst_assigned_to) {
