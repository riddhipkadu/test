...
public interface ExecutedContractService {
	...
	public int updateExecutedContract(ExecutedContractReference contracts,ArrayList<MultipartFile> executed_contract_documents,ArrayList<String> additional_parties, HttpSession session, String status);
	...
	public void addExecContractDocument(int exec_id, MultipartFile executed_contract_documents);
	public int termrenwpersist(TermRenwContract termrenwcontract, HttpSession session, String status,
			ArrayList<MultipartFile> termrenw_documents);
