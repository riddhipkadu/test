...
public class ContractServiceImpl implements ContractService {
			...
			for (int i = 0; i < term_doc.size(); i++) {
				...
				if (file.getSize() > 0) {
					...
					documents.setCdoc_generated_file_name(
							"D:/"+project_name+"/Documents/PreExecutionContractDocuments/" + generatedFileName);
	...
	public List<ContractReference> getJoinedContractDetails(HttpSession session) {
		try {
			...
			while (itr.hasNext()) {
				...
				if(object[13]!=null)
				    contractReference.setCont_start_date(sdfOut.format(sdfIn.parse(object[13].toString())));
				else
					contractReference.setCont_start_date("NA");
				
				if(object[14]!=null)
				    contractReference.setCont_end_date(sdfOut.format(sdfIn.parse(object[14].toString())));
				else
					contractReference.setCont_end_date("NA");
				if(object[15]!=null)
				contractReference.setCont_type_of_contract(object[15].toString());
				else
					contractReference.setCont_type_of_contract("NA");
				contractReference.setCont_payment(object[16].toString());
				
				if(object[17]!=null)
				    contractReference.setCont_reminder_date(sdfOut.format(sdfIn.parse(object[17].toString())));
				else
					contractReference.setCont_reminder_date("NA");
				
				if(object[18]!=null)
				    contractReference.setCont_term((object[18].toString()));
				else
					contractReference.setCont_term("NA");
				
				if(object[19]!=null)
				    contractReference.setCont_nature((object[19].toString()));
				else
					contractReference.setCont_nature("NA");
				
				if(object[20]!=null)
				    contractReference.setCont_surviving_clause((object[20].toString()));
				else
					contractReference.setCont_surviving_clause("NA");
				
				if(object[21]!=null)
				    contractReference.setCont_major_clause((object[21].toString()));
				else
					contractReference.setCont_major_clause("NA");
				
				if(object[22]!=null)
				    contractReference.setCont_damages((object[22].toString()));
				else
					contractReference.setCont_damages("NA");
				
				if(object[23]!=null)
				    contractReference.setCont_instructions((object[23].toString()));
				else
					contractReference.setCont_instructions("NA");
				
				if(object[24]!=null)
				    contractReference.setCont_division((object[24].toString()));
				else
					contractReference.setCont_division("NA");
	...
	public ContractReference getJoinedContractDetailsById(int cont_id) {
		try {
			...
			contractReference.setCont_type_list_name(contractDao.getContractTypeById(Integer.parseInt(object[10].toString())));
			if(object[18] != null)
			...
			if(object[25] != null){
			contractReference.setCont_start_date_name(sdfIn.parse(object[25].toString()));
			contractReference.setCont_start_date(sdfOut.format(sdfIn.parse(object[25].toString())));
			}
			if(object[26] != null){
			contractReference.setCont_end_date_name(sdfIn.parse(object[26].toString()));
			contractReference.setCont_end_date(sdfOut.format(sdfIn.parse(object[26].toString())));
			}
			if(object[27] != null)
			...
			if(object[29] != null){
			contractReference.setCont_reminder_date_name(sdfIn.parse(object[29].toString()));
			contractReference.setCont_reminder_date(sdfOut.format(sdfIn.parse(object[29].toString())));
			contractReference.setCont_req_id(Integer.parseInt(object[30].toString()));
			}
			if(object[31] != null)
				contractReference.setCont_division(object[31].toString());
				else
				contractReference.setCont_division("");
			if(object[32] != null)
			contractReference.setCont_force_majeure(object[32].toString());
			else
				contractReference.setCont_force_majeure("NA");
		...
		try {
			...
			for (int i = 0; i < contract_doc.size(); i++) {
				...
				if (file.getSize() > 0) {
					...
					outputStream.write(file.getBytes());
					generated_file_name = "D:/"+project_name+"/Documents/PreExecutionContractDocuments/" + generatedFileName;
			...
			//***************** save this status in POC status table *************************
				...
				for (int i = 0; i < contract_doc.size(); i++) {
					...
					if (file.getSize() > 0) {
						...
						outputStream.write(file.getBytes());
						generated_poc_file_name = "D:/"+project_name+"/Documents/POCDocuments/" + generatedPOCFileName;
	...
	public String searchContract(String json, HttpSession session) {
		try {
			...
			while (iterator.hasNext()) {
				...
				if(objects[13]!=null)
					   jsonObject.put("cont_start_date", sdfOut.format(sdfIn.parse(objects[13].toString())));
					else
						jsonObject.put("cont_start_date", "NA");
				
				if(objects[14]!=null)
					   jsonObject.put("cont_end_date", sdfOut.format(sdfIn.parse(objects[14].toString())));
					else
						jsonObject.put("cont_end_date", "NA");
				
				if(objects[15]!=null)
				jsonObject.put("cont_type_of_contract", objects[15].toString());
				else
				jsonObject.put("cont_type_of_contract", "NA");
				
				if(objects[16]!=null)
				jsonObject.put("cont_payment", objects[16].toString());
				else
				jsonObject.put("cont_payment", "NA");
				
				if(objects[17]!=null)
					   jsonObject.put("cont_reminder_date", sdfOut.format(sdfIn.parse(objects[17].toString())));
					else
						jsonObject.put("cont_reminder_date", "NA");
				
				if(objects[18]!=null)
				jsonObject.put("cont_term", objects[18].toString());
				else
				jsonObject.put("cont_term", "NA");
				
				if(objects[19]!=null)
				jsonObject.put("cont_nature", objects[19].toString());
				else
				jsonObject.put("cont_nature", "NA");
				
				if(objects[20]!=null)
					jsonObject.put("cont_surviving_clause",(objects[20].toString()));
				else
					jsonObject.put("cont_surviving_clause", "NA");
				
				if(objects[21]!=null)
					jsonObject.put("cont_major_clause",(objects[21].toString()));
				else
					jsonObject.put("cont_major_clause", "NA");
				
				if(objects[22]!=null)
					jsonObject.put("cont_damages", (objects[22].toString()));
				else
					jsonObject.put("cont_damages", "NA");
				
				if(objects[23]!=null)
					jsonObject.put("cont_instructions",(objects[23].toString()));
				else
					jsonObject.put("cont_instructions", "NA");
				
				if(objects[24]!=null)
					jsonObject.put("cont_division",(objects[24].toString()));
				else
					jsonObject.put("cont_division", "NA");
	...
	public void updateContract(ContractReference contractRef, ArrayList<MultipartFile> term_doc,
		...
		try {
			...
			newContract.setCont_division(contractRef.getCont_division());
			...
			newContract.setCont_start_date(contractRef.getCont_start_date_name());
			newContract.setCont_end_date(contractRef.getCont_end_date_name());
			newContract.setCont_damages(contractRef.getCont_damages());
			newContract.setCont_instructions(contractRef.getCont_instructions());
			newContract.setCont_reminder_date(contractRef.getCont_reminder_date_name());
			newContract.setCont_req_id(Oldcontract.getCont_req_id());
			newContract.setCont_force_majeure(contractRef.getCont_force_majeure());
