...
public class UtilitiesServiceImpl implements UtilitiesService {
	...
	public void addMailToLog(String username, String subject) {
		...
		File dir = new File("D:" + File.separator + project_name + File.separator + "EmailLogs");
		if (!dir.exists())
			dir.mkdirs();
		...
		try (FileWriter fw = new FileWriter(
				"D:" + File.separator + project_name + File.separator + "EmailLogs" + File.separator + "logs.txt", true);
	...
	public void addMailToLog(String username, String usernameCC, String subject, String id) {
		...
		try(FileWriter fw = new FileWriter("D:"+ File.separator +project_name+ File.separator +"EmailLogs" + File.separator + "logs.txt", true);
			    BufferedWriter bw = new BufferedWriter(fw);
			    PrintWriter out = new PrintWriter(bw))
			{
			    out.println("mail sent to: "+ username);
