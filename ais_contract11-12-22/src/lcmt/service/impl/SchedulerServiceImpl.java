...
public class SchedulerServiceImpl implements SchedulerService {
	...
	public List<Object> getAssignPersonExecutedContract() {
		...
		try {
			return schedulerDao.getAssignPersonExecutedContract();
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
	...
	public List<Object> getReminderContractExpiryAlertToAssignPerson(int assign_to) {
		// TODO Auto-generated method stub
		try {
			return schedulerDao.getReminderContractExpiryAlertToAssignPerson(assign_to);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
	...
	public List<Object> getAllEntityHeadByOrgaId(int orga_id) {
		try {
			return schedulerDao.getAllEntityHeadByOrgaId(orga_id);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
