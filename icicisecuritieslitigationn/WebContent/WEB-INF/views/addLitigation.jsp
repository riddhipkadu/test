...
<div class="page_container">
	<div class="container">
		...
		<sf:form class="form-horizontal" commandName="litigation"
			enctype="multipart/form-data" action="./saveLititgation"
			method="POST">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<sf:select path="liti_orga_id" <%-- items="${allOrganizations}" >
									...
									<sf:option value="1">ICICI Securities</sf:option>
								</sf:select>
			...
			<div class="f_form_content">
				...
				<div class="col-md-12" style="margin-top: 10px;">
					<div class="col-md-8">
						<div class="form-group">
							<label class="control-label col-sm-4">Date of Receipt of Notice :</label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							...
							<div class="col-sm-6 litigation_buttons">
								<button type="button" class="btn btnTaskCompDoc"
									onclick="addTermFileInput();">Add Document</button>
							</div>
						</div>
					</div>
				</div>
