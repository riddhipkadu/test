...
<div class="page_cont_padd">
	<div class="page_container">
		...
		<!--first form-->
		<sf:form class="form-horizontal" role="form" commandName="addCounselFees" onsubmit="return validateForm();" action="./saveCounselFees"  method="POST" enctype="multipart/form-data">
			<div class="col-md-10">
				<div class="header_button">
					<!--<button type="button" class="btn btn-primary" id="wdt_re">Litigation Summary</button>-->
					<h2 style="color: #032BEC; font-size: 24px; float: left;">Counsels Fees</h2>
					...
					<div class="col-md-6">
						...
						<div class="form-group" style="display:none">
							<label class="control-label col-sm-5" for="sel1">Id
								:</label>
							<div class="col-sm-7">
								<sf:input path="lcou_liti_id" value='<%=request.getParameter("liti_id")%>'/>
						...
						<%-- <div class="form-group" style="display:none">
							...
							<div class="col-sm-7">
								<sf:input type="hidden" class="form-control" path="lcou_counsel_id" value="${litigationDetails.exte_coun_id}" />
							</div>
						</div> --%>
						<%-- <div class="form-group" >
						 ...
						 <div class="form-group">
							...
							<div class="col-sm-7">
								<sf:select class="validate[required]" items="${allLawFirm}" path="lcou_law_firm_id">
						...
						<div class="form-group">
							...
							<sf:select class="form-control"  path="lcou_counsel_id" id="lcou_counsel_id">
								  ...
								  <%--  <sf:option value="1">lump sum</sf:option>
								   <sf:option value="2">appearance</sf:option>
								   <sf:option value="3">Hourly</sf:option> --%>
							 </sf:select><i class="asterisk_input"></i>
							</div>
						</div> 
					   <div class="form-group">
