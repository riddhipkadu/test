...
<div class="page_container">
	...
	<sf:form class="form-horizontal" role="form"
		commandName="addLegalNotice" enctype="multipart/form-data"
		...
		<div class="col-md-10">
			<div class="header_button">
				...
				<h2 style="color: #a72f14; font-size: 24px; float: left;">New
					Legal Notice</h2>
		...
		<div class="f_form_content">
			...
			<div class="col-md-12">
				<div class="col-md-6">
					...
					<%-- 	<div class="form-group">
						<label class="control-label col-sm-5" for="sel1">Unit/Location
							:</label>
						<div class="col-sm-7">
							<sf:select class="form-control" name="lega_noti_unit_id"
								path="lega_noti_unit_id" id="lega_noti_unit_id">
					...
					<div class="form-group">
						<label class="control-label col-sm-5" for="sel1">Function/Department
							:</label>
						<div class="col-sm-7">
							<sf:select class="form-control" name="lega_noti_function_id"
								path="lega_noti_function_id" id="lega_noti_function_id">
								<option value="0">--Select--</option>
							</sf:select>
							<i class="asterisk_input"></i>
						</div>
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						<label class="col-sm-5 control-label">Notice reminder date
							:</label>
						<div class="col-sm-7">
							<div id="noti_remain_div" class="input-group date"
								data-date-format="MM">
								<sf:input cssClass="form-control" path="lega_noti_reminder_date"
									id="lega_noti_reminder_date" name="lega_noti_reminder_date"
									readonly="true" />
								<span class="input-group-addon"><i
									class="glyphicon glyphicon-calendar"></i></span>
							</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<sf:select class="form-control" items="${allExternalCounsel}"
								name="lega_noti_external_counsel_id"
					...
					<div class="form-group">
						<label class="col-sm-5 control-label">Brief Facts/Comments
							:</label>
						<div class="col-sm-7">
				...
				<div class="col-md-12">
					<div class="f_form_content">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<sf:input path="lega_noti_total_amount"
											cssClass="form-control" placeholder="Enter Total_Amount"
											readonly="true" />
										<!-- <i class="asterisk_input"></i> -->
						...
						<div class="col-md-12">
							<div class="col-md-8">
								<div class="form-group">
									<label class="col-sm-2 control-label">Prayer Details :</label>
									<div class="col-sm-6">
										<sf:textarea rows="2" cols="42"
											path="lega_noti_prayer_details" id="lega_noti_prayer_details"
			...
			<div class="col-md-12 litigation_buttons">
				...
				<center>
					<button type="submit" value="Save" name="Save"
						class="btn btn-myPrimary">Create</button>
					<button type="submit" name="Draft" value="Draft"
						class="btn btn-myDefault">Save As Draft</button>
				</center>
