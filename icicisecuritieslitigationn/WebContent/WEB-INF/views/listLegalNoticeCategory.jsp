		...
		<div class="col-md-10">
			<div class="header_button">
				...
				<h2 style="color: #a72f14; font-size: 24px; float: left;">Legal
					Notice List</h2>
				<a href="./masters"><img src="images/DashboardIcons/backold.png"
					class="backButton" width="100px;"></a>

			</div>
		</div>
		<div class="col-md-2">
			<center>
				<a href="./addLegalNoticeCatagory" class="btn btn-primary">Add
					Legal Notice Category</a>
			</center>
		</div>
	</div>
			...
			<table id="example" class="table table-striped table-bordered"
				...
				<thead>
					<tr style="background: #a72f14; color: #fff;">
						<th>Id</th>
						<th>Legal Notice Category Name</th>
				...
				<tbody>
					<c:forEach items="${listLegalNoticeCategory}" var="legal"
						varStatus="loop">
						<tr id="row_${legal.lega_noti_category_id}">
							<td>${loop.index+1 }</td>
							<td>${legal.lega_noti_category_name}</td>
							<td class="edit"><a
								href="editLegalNoticeCategory?lega_noti_category_id=${legal.lega_noti_category_id}"><button
							...
							<td class="delete"><button type="button"
									value="${legal.lega_noti_category_id}"
									name='delete_lega_noti_category' class="btn btn-danger">
