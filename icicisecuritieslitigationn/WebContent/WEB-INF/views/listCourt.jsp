...
<div class="col-md-10">
				<div class="header_button">
					...
					<h2 style="color:#a72f14;font-size:24px;float:left;">Court List</h2>
					<a href="./masters"><img src="images/DashboardIcons/backold.png" class="backButton" width="100px;"></a>

				</div>
				</div>
				<div class="col-md-2">
				<center><a href="./addCourt" class="btn btn-primary">Add Court</a></center>
				</div>
			</div>
	...
	<!--first form-->
        ...
        <tbody>
          <c:forEach items="${listCourt}" var="court" varStatus="loop">
					<tr id="row_${court.court_id}">
						<td>${loop.index+1 }
						<td>${court.court_name}</td>
						<td class="edit"><a href="editCourt?court_id=${court.court_id}"><button type="button" onclick=""
							name='submit' value="submit" class="btn btn-primary">
							<i class='fa fa-pencil-square-o'></i>&nbsp;Edit
						</button></a></td>
						
						<td class="delete"><button type="button" value="${court.court_id}"
											 name='delete_court' 
