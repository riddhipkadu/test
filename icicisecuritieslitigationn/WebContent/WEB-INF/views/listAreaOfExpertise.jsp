	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>This Area Of Expertise Field is used in External Counsel.
					Can't be deleted</p>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
<div class="page_container">
	...
	<div class="col-md-12">
		...
		<div class="col-md-2">
			<center>
				<a href="./addAreaOfExpertise" class="btn btn-primary">Add Area
					Of Expertise</a>
			</center>
		</div>
	</div>
	...
	<div class="table_data1">
		...
		<div class="container">
			...
			<table id="example" class="table table-striped table-bordered"
				...
				<tbody>
					<c:forEach items="${listAreaOfExpertise}" var="expertise"
						varStatus="loop">
						<tr id="row_${expertise.area_expe_id}">
							<td>${loop.index+1}</td>
							<td>${expertise.area_expe_name}</td>
							<td class="edit"><a
								href="editAreaOfExpertise?area_expe_id=${expertise.area_expe_id}"><button
							...
							<td class="delete"><button type="button"
									value="${expertise.area_expe_id}" name='delete_area_expe'
