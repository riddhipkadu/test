...
<!--heading text-->
			...
			<div class="col-md-12">
				<div class="header_button">
					...
					<h2 style="color:#032BEC;font-size:24px;float:left;">Update Query Request</h2>
	...
	<sf:form autocomplete="off" cssClass="form-horizontal" commandName="editQueryRequest" enctype="multipart/form-data" action="./updateQueryRequest" method="POST">
				
			<div class="f_form_content">
			<h2>Edit Query Request</h2>
				...
				<%-- <div class="col-md-12">
					...
					<div class="col-md-4" style="display:none">
							<div class="form-group" >
								...
								<div class="col-sm-8">
									<sf:input path="req_query_id" id="req_query_id" />
								</div>
							</div>
						</div>
					<div class="col-md-12">
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<sf:select class="form-control" path="req_query_entity_id" id="req_query_entity_id">
									   <c:forEach items="${allOrganizations}" var="organization">
				...
				<%-- <div class="col-md-12">
					...
					<div class="col-md-12">
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<sf:select class="form-control" path="req_query_unit_id" id="req_query_unit_id">
									   <option value="0">--Select--</option>
					...
					<div class="col-md-12">
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<sf:select class="form-control" items="${allDepartments }"  path="req_query_function_id" id="req_query_function_id">
									   <option value="0">--Select--</option>
...
<!-- 					</div> -->
					<div class="col-md-12">
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<sf:textarea class="form-control" rows="4" cols="6" id="req_query" path="req_query" placeholder="Enter Query"></sf:textarea><i class="asterisk_input"></i>
							</div>
						</div>
					</div>
					<%-- <div class="col-md-12">
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<div class="input-group date" id="quer_date_div" data-date-format="MM">
									<sf:input id="req_query_date"  class="form-control" type="text" 
										   path="req_query_date" readonly="true"></sf:input><span class="input-group-addon"><i
					...
					<div class="col-md-12">
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<sf:select class="form-control" path="req_query_criticality" id="req_query_criticality">
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<div class="input-group date" id="turnarond_date_div" data-date-format="MM">
									<sf:input id="req_query_turnaround_time" class="form-control" type="text" readonly="true"
										 path="req_query_turnaround_time" value="" /> <span class="input-group-addon"><i
										class="glyphicon glyphicon-calendar"></i></span>
								</div>
							</div>
						</div>
