...
<!--heading text-->
			<div class="col-md-12">
				<div class="header_button">
					...
					<h2 style="color:#032BEC;font-size:24px;float:left;">Contract Request</h2>
					<a href="./listContractRequest"><img src="images/DashboardIcons/backold.png" class="backButton" width="100px;"></a>
				</div>
			</div>
	<div style="clear:both"></div>
	<!--first form-->
<sf:form autocomplete="off" role="form" class="form-horizontal" commandName="addContractRequest" enctype="multipart/form-data" action="./saveContractRequest" method="POST">
				...
				<div class="col-md-12">
					...
					<div class="col-md-6">
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<select class="form-control" name="req_contract_unit_id" id="req_contract_unit_id">
					...
					<div class="col-md-6">
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<select class="form-control" name="req_contract_function_id" id="req_contract_function_id">
									   <option value="0">--Select--</option>
					...
					<%-- <div class="col-md-12">
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<sf:input path="sfco_name" class="form-control" type="text" name="sfco_name" onkeypress="return blockSpecialChar(event);" />
				...
				<div class="col-md-12">
					...
					<div class="col-md-6">
						<div class="form-group row">
							...
							<input id="req_contract_perform_rel_payment" name="req_contract_perform_rel_payment" class="form-control" placeholder="Enter Payment" />
							     <i class="asterisk_input"></i>
					...
					<div class="col-md-6">
						<div class="form-group row">
							...
							<input id="req_contract_notice_period" name="req_contract_notice_period" class="form-control" onkeypress="return isNumber(event)" placeholder="Enter Notice Period"/>
