...
public class Litigation {
	...
	private Date liti_receipt_notice_date;
	...
	private int liti_updated_by;
	private Date liti_created_at;
	private Date liti_updated_at;
	...
	private Date liti_acm_note_date;
	...
	@Size(max = 3900)
	private String liti_prayer_details;
	private int liti_third_responsible_person;
	private int liti_fourth_responsible_person;
	...
	public Date getLiti_acm_note_date() {
		return liti_acm_note_date;
	}
	public void setLiti_acm_note_date(Date liti_acm_note_date) {
		this.liti_acm_note_date = liti_acm_note_date;
	}
	public int getLiti_updated_by() {
		return liti_updated_by;
	}
	public void setLiti_updated_by(int liti_updated_by) {
		this.liti_updated_by = liti_updated_by;
	}
	public Date getLiti_updated_at() {
		return liti_updated_at;
	}
	public void setLiti_updated_at(Date liti_updated_at) {
	...
	public int getLiti_fourth_responsible_person() {
		return liti_fourth_responsible_person;
	}
	public void setLiti_fourth_responsible_person(int liti_fourth_responsible_person) {
		this.liti_fourth_responsible_person = liti_fourth_responsible_person;
	}
	public String getLiti_prayer_details() {
		return liti_prayer_details;
	}
	public void setLiti_prayer_details(String liti_prayer_details) {
		this.liti_prayer_details = liti_prayer_details;
	}
	...
	public Date getLiti_receipt_notice_date() {
		return liti_receipt_notice_date;
	}
	public void setLiti_receipt_notice_date(Date liti_receipt_notice_date) {
