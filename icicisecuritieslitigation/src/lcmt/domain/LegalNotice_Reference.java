...
public class LegalNotice_Reference {

	private int lega_noti_id;
	private int lega_noti_entity_id;
	private String lega_noti_entity_name;
	private int lega_noti_unit_id;
	private String lega_noti_unit_name;
	private int lega_noti_function_id;
	private String lega_noti_function_name;
	...
	private String lega_noti_dated;
	private String lega_noti_recived_on;
	private String lega_noti_reply_deadline;
	private int lega_noti_assigned_to_id;
	private int lega_noti_secondary_responsible_person;
	private String lega_noti_secondary_responsible_person_name;
	private int lega_noti_third_responsible_person;
	private String lega_noti_third_responsible_person_name;
	private int lega_noti_other_responsible_person;
	private String lega_noti_other_responsible_person_name;
	private String lega_noti_assigned_to_name;
	private int lega_noti_external_counsel_id;
	private String lega_noti_external_counsel_name;
	...
	private String lega_noti_reminder_date;
	private String lega_noti_created_at;
	private String lega_noti_updated_at;
	...
	public String getLega_noti_entity_name() {
		return lega_noti_entity_name;
	}
	public void setLega_noti_entity_name(String lega_noti_entity_name) {
		this.lega_noti_entity_name = lega_noti_entity_name;
	}
	...
	public String getLega_noti_unit_name() {
		return lega_noti_unit_name;
	}
	public void setLega_noti_unit_name(String lega_noti_unit_name) {
		this.lega_noti_unit_name = lega_noti_unit_name;
	}
	...
	public String getLega_noti_function_name() {
		return lega_noti_function_name;
	}
	public void setLega_noti_function_name(String lega_noti_function_name) {
		this.lega_noti_function_name = lega_noti_function_name;
	}
	...
	public String getLega_noti_dated() {
		return lega_noti_dated;
	}
	public void setLega_noti_dated(String lega_noti_dated) {
		this.lega_noti_dated = lega_noti_dated;
	}
	public String getLega_noti_recived_on() {
		return lega_noti_recived_on;
	}
	public void setLega_noti_recived_on(String lega_noti_recived_on) {
		this.lega_noti_recived_on = lega_noti_recived_on;
	}
	public String getLega_noti_reply_deadline() {
		return lega_noti_reply_deadline;
	}
	public void setLega_noti_reply_deadline(String lega_noti_reply_deadline) {
	...
	public String getLega_noti_assigned_to_name() {
		return lega_noti_assigned_to_name;
	}
	public void setLega_noti_assigned_to_name(String lega_noti_assigned_to_name) {
		this.lega_noti_assigned_to_name = lega_noti_assigned_to_name;
	}
	...
	public String getLega_noti_external_counsel_name() {
		return lega_noti_external_counsel_name;
	}
	public void setLega_noti_external_counsel_name(String lega_noti_external_counsel_name) {
		this.lega_noti_external_counsel_name = lega_noti_external_counsel_name;
	}
	...
	public String getLega_noti_reminder_date() {
		return lega_noti_reminder_date;
	}
	public void setLega_noti_reminder_date(String lega_noti_reminder_date) {
		this.lega_noti_reminder_date = lega_noti_reminder_date;
	}
	public String getLega_noti_created_at() {
		return lega_noti_created_at;
	}
	public void setLega_noti_created_at(String lega_noti_created_at) {
		this.lega_noti_created_at = lega_noti_created_at;
	}
	public String getLega_noti_updated_at() {
		return lega_noti_updated_at;
	}
	public void setLega_noti_updated_at(String lega_noti_updated_at) {
	...
	public String getLega_noti_secondary_responsible_person_name() {
		return lega_noti_secondary_responsible_person_name;
	}
	public void setLega_noti_secondary_responsible_person_name(String lega_noti_secondary_responsible_person_name) {
		this.lega_noti_secondary_responsible_person_name = lega_noti_secondary_responsible_person_name;
	}
	public String getLega_noti_third_responsible_person_name() {
		return lega_noti_third_responsible_person_name;
	}
	public void setLega_noti_third_responsible_person_name(String lega_noti_third_responsible_person_name) {
		this.lega_noti_third_responsible_person_name = lega_noti_third_responsible_person_name;
	}
	public String getLega_noti_other_responsible_person_name() {
		return lega_noti_other_responsible_person_name;
	}
	public void setLega_noti_other_responsible_person_name(String lega_noti_other_responsible_person_name) {
		this.lega_noti_other_responsible_person_name = lega_noti_other_responsible_person_name;
	}
