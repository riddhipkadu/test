...
<div class="page_container">
	...
	<!--first form-->
	<sf:form class="form-horizontal" role="form" commandName="lawFirm"
		autocomplete="off" action="./saveLawFirm"
		...
		<div class="f_form_content">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						<label class="control-label col-sm-5" for="sel1"> Law Firm
							Name :</label>
						<div class="col-sm-7">
							<sf:input type="text" cssClass="form-control" path="lawf_name"
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<sf:input type="text" cssClass="form-control"
								path="lawf_mobile_no" id="lawf_mobile_no" name="lawf_mobile_no" />
							<i class="asterisk_input"></i>
						</div>
					</div>
					<div class="form-group">
			...
			<div class="col-md-12 litigation_buttons">
				<button type="submit" class="btn btn-myPrimary"
					style="margin-left: 340px;">Create</button>
