...
<div class="col-md-10">
				<div class="header_button">
					...
					<h2 style="color:#a72f14;font-size:24px;float:left;">Currency List</h2>
					<a href="./masters"><img src="images/DashboardIcons/backold.png" class="backButton" width="100px;"></a>

				</div>
				</div>
				<div class="col-md-2">
				<center><a href="./addCurrency" class="btn btn-primary">Add Currency</a></center>
				</div>
			</div>
	...
	<!--first form-->
        ...
        <tbody>
          <c:forEach items="${listCurrency}" var="currency" varStatus="loop">
					<tr id="row_${currency.curr_id}">
						<td>${loop.index+1 }</td>
						<td>${currency.curr_code}</td>
						<td>${currency.curr_name}</td>
						<%-- <td>${currency.curr_rate}</td> --%>
						<td class="edit"><a href="editCurrency?curr_id=${currency.curr_id}"><button type="button" onclick=""
							name='submit' value="submit" class="btn btn-primary">
							<i class='fa fa-pencil-square-o'></i>&nbsp;Edit
						</button></a></td>
						<td class="delete"><button type="button" value="${currency.curr_id}"
