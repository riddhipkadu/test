...
<div class="page_cont_padd">
	<div class="page_container">
		...
		<!--first form-->
		<sf:form class="form-horizontal" role="form" commandName="pay_advocate" action="./savePaidAdvocateFees"  method="POST" enctype="multipart/form-data" onsubmit="return validateForm();">
			
			<div class="col-md-10">
				<div class="header_button">
					<h2 style="color: #a72f14; font-size: 24px; float: left;">Pay Advocate Fees</h2>
				...
				<div class="col-md-12">
					...
					<div class="col-md-6">
						...
						<div class="form-group" style="display:none">
							...
							<div class="col-sm-7">
								<sf:input path="apaid_advocate_fees_id" value="${advocate_fees_id}" cssClass="form-control"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<sf:input path="apaid_invoice_amt" cssClass="form-control" maxlength="9"/><i class="asterisk_input"></i>
							</div>
							<div class="col-sm-3">
