...
<!-- Fail Modal END -->
	...
	<div class="page_container">
		...
		<sf:form class="form-horizontal" role="form"
			enctype="multipart/form-data" commandName="editHearingStage"
			...
			<div class="col-md-10">
				<div class="header_button">
					...
					<h2 style="color: #a72f14; font-size: 24px; float: left;">Edit
						Hearing Stage</h2>
					<a href="./litigationDetails?liti_id=${liti_id }"><img
			...
			<div class="f_form_content">
				...
				<div class="col-md-12">
					...
					<div class="col-md-6">
							...
							<div class="col-sm-7">
								<div id="second_alert_div" class="input-group date"
									...
									<sf:input class="form-control" path="ttrn_second_alert"
										id="ttrn_second_alert" name="ttrn_second_alert"
										readonly="true" />
									<span class="input-group-addon"><i
										class="glyphicon glyphicon-calendar"></i></span>
								</div>
						...
						<div class="form-group">
							<label class="control-label col-sm-5" for="sel1">Additional
								Email Id :</label>
							<div class="col-sm-7">
							...
							<p style="text-align: right;">(Please enter atmost three
								Email id separated by comma)</p>
						</div>
				<div class="form-group">
						<label class="control-label col-sm-5 ">Stage Description :</label>
						<div class="col-sm-7">
							<sf:textarea rows="3" cols="42" path="ttrn_stage_description"
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<label class="control-label col-sm-5" for="sel1">Action
								Item :</label>
							<div class="col-sm-7">
								<sf:textarea rows="2" cols="35" class="form-control"
									path="ttrn_action_item" id="ttrn_action_item"
									name="ttrn_action_item"></sf:textarea>
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-5" for="sel1">Primary Responsible
								Person :</label>
							<div class="col-sm-7">
						...
						<div class="form-group">
							<label class="control-label col-sm-5" for="sel1">Secondary Responsible
								Person:</label>
							<div class="col-sm-7">
								<sf:select class="form-control" name="ttrn_secondary_person"
									path="ttrn_secondary_person" id="ttrn_secondary_person">
									<sf:option value="0">--Select--</sf:option>
									<c:forEach items="${user_lists}" var="user_legal_department">
										<sf:option value="${user_legal_department.user_id}">${user_legal_department.user_first_name}
											${user_legal_department.user_last_name}</sf:option>
									</c:forEach>
								</sf:select>
							...
							<div class="col-sm-7">
								<sf:select class="form-control" path="ttrn_counsel_law_firm_id"
									...
									<c:forEach items="${allLawFirm}" var="lawf">
										<sf:option value="${lawf.key}" selected="selected">${lawf.value}</sf:option>
									</c:forEach>
								</sf:select>
							</div>
						</div>
							...
							<div class="col-sm-7">
								<sf:select class="form-control" name="ttrn_counsel_id"
									...
									<c:forEach items="${external_counsel_list}"
										...
										<sf:option value="${external_counsel.exte_coun_id}"
											selected="selected">${external_counsel.exte_coun_name}</sf:option>
									</c:forEach>
								</sf:select>
								<!-- <i class="asterisk_input"></i> -->
							</div>
						...
						<div class="form-group">
							<label class="control-label col-sm-5">Action item due
								Date :</label>
							<div class="col-sm-7">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<c:forEach items="${hearing_stage_doc}" var="document"
											varStatus="doc">
											<div id="doc_attached_${document.hear_doc_id}"
												class="col-sm-3">
