...
<div class="page_cont_padd">
		...
		<div class="container">
			...
			<div class="task_tabs">
				<ul id="myTab" class="nav nav-tabs mynav-tabs">
					...
					<!-- <li><a href="#casedocuments"
						data-toggle="tab">Litigation case documents</a></li> -->
					<li><a href="#hearingdates" data-toggle="tab"
						id="hearingStage"> Next Hearing & Stage </a></li>
				...
				<div id="myTabContent" class=" container tab-content">
					<div class="tab-pane fade active in" id="LitigationDetails"
						...
						<table id="example" class="table table-striped table-bordered"
							...
							<tr>
								<td colspan="2"
									style="text-align: center; background-color: grey; color: white; font-size: 23px;"><strong>Case
										Details</strong> <!-- <div style="float: right;">
										<input type="button" name="export" class="btn btn-danger"
											value="Export In To Word">
									</div> --></td>
							</tr>
							<tr>
								<td style="width: 200px;"><strong>Litigation Id</strong></td>
							...
							<tr>
								<td style="width: 200px;"><strong>Litigation
										Reference number</strong></td>
								<td><c:choose>
										<c:when
											test="${litigation_details_by_id.liti_previous_liti_ref_no != '0'}">
											<a
												href="litigationDetails?liti_id=${previous_liti_client_id }"
												style="color: blue;">
							...
							<tr>
								<td style="width: 200px;"><strong>Match Id/ Employee Code</strong></td>
							...
							<tr>
								<td style="width: 200px;"><strong>Jurisdiction
										name/City </strong></td>
						...
						<%-- 	<tr>
							...
							<tr>
								<td style="width: 200px;"><strong>Primary Responsible Person </strong></td>
								<td>${litigation_details_by_id.liti_assigned_name }</td>
							</tr>
							<tr>
								<td style="width: 200px;"><strong>Secondary
										Responsible Person </strong></td>
								<td>${litigation_details_by_id.liti_secondary_responsible_name }</td>
							</tr>
							<tr>
								<td style="width: 200px;"><strong>Third
										Responsible Person </strong></td>
								<td>${litigation_details_by_id.liti_third_responsible_name }</td>
							</tr>
							<tr>
								<td style="width: 200px;"><strong>Fourth
										Responsible Person </strong></td>
								<td>${litigation_details_by_id.liti_fourth_responsible_name }</td>
							</tr>

							<tr>
								<td style="width: 200px;"><strong>Internal Contact
										Person</strong></td>
								<td>${litigation_details_by_id.liti_intenal_person }</td>
							</tr>
							<tr>
								<td style="width: 200px;"><strong>Risk Analysis </strong></td>
								<td>${litigation_details_by_id.liti_criticality }</td>
							</tr>
							
							<tr>
								<td style="width: 200px;"><strong>Payable or Receivable: </strong></td>
								<td>${litigation_details_by_id.liti_pay }</td>
							</tr>
							
							<tr>
								<td style="width: 200px;"><strong>Part of ACM Note</strong></td>
								<td>${litigation_details_by_id.liti_part_acm }</td>
							</tr>
							
							<tr>
								<td style="width: 200px;"><strong>Date For MIS Purpose </strong></td>
								<td>${litigation_details_by_id.liti_acm_note_date }</td>
							</tr>
							<%-- <tr>
							...
							<tr>
								<td style="width: 200px;"><strong>Opposite Party
										address</strong></td>
							...
							<tr>
								<td style="width: 200px;"><strong>Opposite Party
										advocate law firm</strong></td>
								<td>${litigation_details_by_id.liti_oppo_advo_law_firm }</td>
							</tr>
							<tr>
								<td style="width: 200px;"><strong>Opposite Party
										advocate contact number</strong></td>
						...
						<%-- 	<tr>
								...
								<td>${litigation_details_by_id.liti_amount_involved }
									</td>
							</tr> --%>
							...
							<tr>
						 	  ...
						 	  <tr>
								<td style="width: 200px;"><strong>Nature of
										Complaint</strong></td>
								<td>${litigation_details_by_id.liti_nature_of_complaint }</td>
							</tr>
							<tr>
								<td style="width: 200px;"><strong>Status of Case</strong></td>
								<td>${litigation_details_by_id.liti_status_of_case }</td>
							</tr>
							<tr>
								<td style="width: 200px;"><strong>Date of Receipt of Notice</strong></td>
								<td>${litigation_details_by_id.liti_receipt_notice_date }</td>
							</tr>
							
							
						<%-- 	<tr>
								<td style="width: 200px;"><strong>Link of
										Website</strong></td>
								<td>${litigation_details_by_id.liti_link_of_website }</td>
							</tr> --%> 
								<tr>
								<td style="width: 200px;"><strong>Amount Involved</strong></td>
								<td>${litigation_details_by_id.liti_amount_involved }
								...
								<tr>
								<td style="width: 200px;"><strong>Interest</strong></td>
								<td>${litigation_details_by_id.liti_interest }</td>
							</tr> 
							<tr>
								<td style="width: 200px;"><strong>Total Amount</strong></td>
								<td>${litigation_details_by_id.liti_total_amount }</td>
							</tr>
	...
	<%-- 		<!--  -->		<!--  --> <!--  -->
			<div class="tab-pane fade" id="casedocuments">
                          ...
                          <table id="example" class="table table-striped table-bordered" width="100%" cellspacing="0">
							...
							<tbody>
								...
								<c:forEach items="${allDocuments}" var="document"
									varStatus="doc">
									<tr id="row_${document.ldoc_id}">

										<td>${doc.index+1}</td>
										<td><a
											href="./downloadLitigationDocument?ldoc_id=${document.ldoc_id}">${document.ldoc_original_file_name}</a></td>
										<td><button type="button" value="${document.ldoc_id}" name='delete_litigation_document'
			...
			<!--  -->		<!--  --><!--  --><!--  -->
						...
						<table id="example">
							<tr>
								...
								<td style="text-align: right;"><c:if
										test="${litigation_details_by_id.liti_status!='Completed' && litigation_details_by_id.liti_status!='Draft'}">
										<a
											href="addHearingStage?liti_id=${litigation_details_by_id.liti_id }"><input
							...
							<tr>
								<td style="text-align: left; font-size: 18px;"><strong>Hearing
										Summary</strong></td>
								<td></td>
							</tr>
							<tr>
					...
					<div class="tab-pane fade" id="Document" style="padding: 10px;">
						...
						<ul id="myTab" class="nav nav-tabs mynav-tabs">
							<li class="active"><a href="#litigationcaseTab" data-toggle="tab">Litigation Case Documents</a></li>
							<li><a href="#synopsisTab" data-toggle="tab">Synopsis</a></li>
							
							<li><a href="#actsTab" data-toggle="tab">Acts</a></li>
							<li><a href="#statutoryTab" data-toggle="tab">Statutory
									Provisions</a></li>
			...
			<div id="myTabContent1" class=" container tab-content">
				...
				<!-- <!--  --> 					<!-- <!--  -->           <!-- <!--  --> 	
				<div class="tab-pane fade active in" id="litigationcaseTab" style="padding: 10px;">
								...
								<div class="f_form_content">
									...
									<div class="col-md-12">
										...
										<div class="col-md-2">
											<input type="button"
												class="btn btn-primary addLitigationDocuments"
												value="Add Document" onclick="addFileInputLitigation(6);" />
										</div>
									</div>
									<div>
										<form class="form-horizontal" role="form"
											id="addLitigationDocumentForm"
											name="addLitigationDocumentForm" method="post"
											enctype="multipart/form-data">
											<input type="text" id="ldoc_liti_id" name="ldoc_liti_id"
												value="${litigation_details_by_id.liti_id }" hidden="">
											<input type="text" value="LitigationCaseDocuments"
												id="ldoc_document_type" name="ldoc_document_type" hidden="" />
											<div id="fileAddingForm6"></div>
				           ...
				           <c:forEach items="${allDocuments}" var="document"
									...
									<tr id="row_${document.ldoc_id}">
										...
										<td><button type="button" value="${document.ldoc_id}" name='delete_litigation_document'
														...
														<c:choose>
															<c:when
																test="${not empty litigation_details_by_id.liti_documents }">

																<c:forEach
																	items="${litigation_details_by_id.liti_documents}"
																	var="liti_docs_liti_related"
																	varStatus="liti_docs_loop_liti_related">
																	<c:choose>
																		<c:when
																			test='${liti_docs_liti_related.ldoc_document_type == "LitigationCaseDocuments"}'>
																			<c:set var="liti_docs_loop_liti_var"
																				value="${liti_docs_loop_liti_var+1}" />
																			<tr
																				id="litiDocRow_${liti_docs_liti_related.ldoc_id }">


																				<td>${liti_docs_loop_liti_var }</td>
																				<td><a
																					href="./downloadLitigationDocument?ldoc_id=${liti_docs_liti_related.ldoc_id }">${liti_docs_liti_related.ldoc_original_file_name}</a></td>
					 ...
					 <div class="tab-pane fade" id="synopsisTab"
								style="padding: 10px;">
								<div class="f_form_content">
							...
							<div class="tab-pane fade" id="statutoryTab"
								style="padding: 10px;">
								<div class="col-md-12">
									<div class="f_form_content">
							...
							<div class="tab-pane fade" id="miscellaneousTab"
								style="padding: 10px;">
								<div class="f_form_content">
					...
					<div class="tab-pane fade" id="CounselFees" style="padding: 10px;">
						...
						<ul id="myTab" class="nav nav-tabs mynav-tabs"
							style="width: 251px;">
							<li class="active"><a href="#CounselFeesTab"
								data-toggle="tab">Counsel Fees</a></li>
							<li><a href="#advocateFeesTab" data-toggle="tab">
									Advocate Fees </a></li>

						</ul>
						<div id="myTabContent1" class=" container tab-content">
							<div class="tab-pane fade active in" id="CounselFeesTab"
								style="padding: 10px;">
								<table id="example">
									<tr>
										<td></td>
												...
												<tbody id="">
													<c:forEach items="${CounselFeesDetails}" var="fees"
														...
														<tr>
															...
															<td><c:choose>
																	...
																	<c:otherwise>
																		<c:forEach items="${fees.fees_doc}" var="doc">
																			<a
																				href="./downloadLitigationFeesDocument?fdoc_id=${doc.fdoc_id} ">
															...
															<td><c:if
																	test="${fees.lcoun_fees_added_by==sessionScope.sess_user_id || sessionScope.sess_user_role ==1}">
																	<a href="./editCounselFees?lcou_id=${fees.lcou_id}"><button
																			class="btn btn-primary" value="submit" name="submit"
																			type="button">
																			<i class="fa fa-pencil-square-o"></i>&nbsp;Edit
																		</button></a>
																</c:if> <a
																href="./listPaidCounselFees?counsel_fees_id=${fees.lcou_id}"><button
																		class="btn btn-primary" value="submit" name="submit"
																		type="button">
							...
							<div class="tab-pane fade" id="advocateFeesTab"
								style="padding: 10px;">
								<table id="example">
									<tr>
										<td></td>
									...
									<tr>
										<td style="text-align: left; font-size: 18px;"><strong>Advocate
												Fees</strong></td>
										<td></td>
									</tr>
									<tr>
												...
												<tbody id="">
													<c:forEach items="${AdvocateFeesDetails}" var="fees"
														...
														<tr>
															...
															<td><c:if
																	test="${fees.ladv_added_by==sessionScope.sess_user_id || sessionScope.sess_user_role ==1}">
																	<a href="./editAdvocateFees?ladv_id=${fees.ladv_id}"><button
																			class="btn btn-primary" value="submit" name="submit"
																			type="button" style="margin: 2px">
																			<i class="fa fa-pencil-square-o"></i>&nbsp;Edit
																		</button></a>
																</c:if> <a
																href="./listPaidAdvocateFees?advocate_fees_id=${fees.ladv_id}"><button
																		class="btn btn-primary" value="submit" name="submit"
																		type="button" style="margin: 2px">
																		<i class="fa fa-pencil-square-o"></i>&nbsp;Paid Fees
																	</button></a></td>
					...
					<div class="tab-pane fade" id="Completion" style="padding: 10px;">
						<div class="f_form_content">
							<c:choose>
								<c:when
									test="${litigation_details_by_id.liti_status=='Completed'}">
										...
										<tbody id="litigation_history">
											<tr>
												...
												<td><c:forEach
														...
														<c:choose>
															<c:when
																test="${doc.ldoc_document_type =='LitigationCompletion'}">
																<a
																	href="./downloadLitigationDocument?ldoc_id=${doc.ldoc_id} ">${doc.ldoc_original_file_name}</a>
															</c:when>
														</c:choose>
													</c:forEach></td>
								...
								<c:otherwise>
									<h2>Completion</h2>
									<sf:form commandName="litigation_completion" type="post"
										action="./saveLitiCompletion" enctype="multipart/form-data"
										onsubmit="return validateCompletion();">
										<table>
											<sf:input path="liti_id" type="hidden"
												value="${litigation_details_by_id.liti_id }" />
											<tr>
											...
											<tr>
												...
												<td style="text-align: left; padding: 10px;"><div
														id="datepicker1" class="input-group date"
														data-date-format="MM">
											...
											<tr id="against_tab" style="display: none;">
												...
												<td style="text-align: left; padding: 5px;"><input
													type="radio" value="Yes" name="file_appeal_result"
													id="file_yes"> Yes
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
														...
														.each(
																...
																function(key,
																	...
																	data += "<td>"
																			+ value['resp_person']
																			+ " </td>";
																	var count_coun = Object
																			.keys(value['counsel_list']).length;
																	var j = 1;
																	if (count_coun != 0) {
																		var coun_td = "";
																		$
																		...
																		$
																				.each(
																						...
																						function(
																								key,
																								value) {
																							doc_td += "<a href='downloadHearingDocument?hearing_doc_id="
																									+ value['doc_id']
																									+ "'>"
																									+ value['doc_orig_name']
																									+ "</a> </br>";
																	...
																	if (value['hearing_status'] != 'Waiting for Approval') {
																		if ((value['added_by'] == value['user_id'] || value['user_role'] == 1)) {
																			data += "<a href='editHearingStage?hear_stage_id="
																					+ value['hear_stage_id']
																		...
																		data += '<a href="./addHearingByApprove?id='
																				+ value['hear_stage_id']
																				+ '"><button type="button" onclick="" name="submit" value="submit" class="btn btn-success">';
