		...
		<div class="f_form_content">
			...
			<div class="col-md-12">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input name="user_first_name" id="user_first_name"
								class="form-control" placeholder="Enter First Name" /> <i
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input name="user_last_name" id="user_last_name"
								class="form-control" placeholder="Enter Last Name" /> <i
								class="asterisk_input"></i>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-3" for="sel1">Mobile
							No.:</label>
						<div class="col-sm-9">
							<input name="user_mobile" id="user_mobile" maxlength="12"
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input class="form-control" id="user_email" name="user_email"
								placeholder="Enter email-id" /> <i class="asterisk_input"></i>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="control-label col-sm-3" for="sel1">User
							Name:</label>
						<div class="col-sm-9">
							<input name="user_username" id="user_username"
								class="form-control" placeholder="Enter User Name" /> <i
								class="asterisk_input"></i>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="control-label col-sm-3" for="sel1">User
							Password:</label>
						<div class="col-sm-9">
							<input type="password" name="user_userpassword"
								id="user_userpassword" class="form-control"
								placeholder="Enter Password" /> <i class="asterisk_input"></i>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="password" name="confirm_password"
								...
								placeholder="Enter Confirm Password" /> <i
								class="asterisk_input"></i>
						</div>
					</div>
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						<label class="control-label col-sm-3" for="sel1">Reporting
							Manager:</label>
						<div class="col-sm-9">
							<select class="form-control" name="user_report_to"
								id="user_report_to">
								<option value="0">--Select--</option>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" placeholder="Enter Employee ID"
								name="user_employee_id" id="user_employee_id"
								class="form-control" />
						</div>
					</div>
					<div class="form-group">
				...
				<div class="col-md-12 litigation_buttons">
					<br>
					<center>
						<button type="submit" class="btn btn-myPrimary">Add</button>
...
<script type="text/javascript">
	function getAllLocationForOrganization() {
		...
		var user_orga_id = $("select#user_organization_id option:selected")
				.attr('value');
	...
	function getAllDepartmentsByLocation() {
		var user_orga_id = $("select#user_organization_id option:selected")
				.attr('value');
		var user_loca_id = $("select#user_location_id option:selected").attr(
				'value');
		if (user_loca_id > 0) {
			items = {};
			items["tmap_orga_id"] = user_orga_id;
	...
	$("#user_department_id")
			.change(
					function() {
						...
						if (user_dept_id > 0 && user_loca_id > 0
								&& user_dept_id > 0) {
										...
										success : function(userList) {
											...
											$
													.each(
															...
															function(key, value) {
																//console.log("In loop");
																data += "<option value="+value['user_id']+">"
																		+ value['user_name']
																		+ "</option>";
															});
	...
	function validateForm() {
		...
		if (!(isNaN(fname))) {
			...
			$("#user_first_name").attr("data-placement", "top");
			$("#user_first_name").attr("data-content",
		...
		if (!(fname.length > 2)) {
			...
			$("#user_first_name").attr("data-placement", "top");
			$("#user_first_name").attr("data-content",
					"First Name should be valid length");
			$('#user_first_name').popover('show');
			return false;
		} else {
			$('#user_first_name').popover('destroy');
		...
		if (!(isNaN(lname))) {
			// $("#oerr").innerHTML="this is invalid name ";
			$("#user_last_name").attr("data-placement", "top");
			$("#user_last_name").attr("data-content",
		...
		if (!(lname.length > 1)) {
			...
			$("#user_last_name").attr("data-placement", "top");
			$("#user_last_name").attr("data-content",
					"Last Name should have valid length");
			$('#user_last_name').popover('show');
			return false;
		} else {
			$('#user_last_name').popover('destroy');
		...
		if (!($('#user_username').val().length > 2)) {
			// $("#oerr").innerHTML="this is invalid name ";
			$("#user_username").attr("data-placement", "top");
			$("#user_username").attr("data-content",
					"Username should be valid length");
			$('#user_username').popover('show');
			return false;
		} else {
			$('#user_first_name').popover('destroy');
	...
	$(document)
			.ready(
					function() {
						...
						$("#user_organization_id").on('change',
								getAllLocationForOrganization);
						$("#user_location_id").on('change',
								getAllDepartmentsByLocation);
	...
	var emp_status;
	$("#user_employee_id").keyup(
			function() {
				$('#user_employee_id')
						.val($.trim($('#user_employee_id').val()));
					...
					$.ajax({
						...
						success : function(res) {
							if (res == 0) {
								...
								emp_status = 1;
								$("#user_employee_id").attr("data-placement",
										"top");
								$("#user_employee_id").attr("data-content",
					...
					$.ajax({
						...
						success : function(result) {
							if (result == 0) {
								...
								user_name_status = 1;
								$("#user_username").attr("data-placement",
										"top");
								$("#user_username").attr("data-content",
