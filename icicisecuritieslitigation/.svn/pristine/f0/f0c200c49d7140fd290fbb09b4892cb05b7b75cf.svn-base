...
<div class="col-md-10">
				<div class="header_button">
					...
					<h2 style="color:#a72f14;font-size:24px;float:left;">Stages List</h2>
					<a href="./masters"><img src="images/DashboardIcons/backold.png" class="backButton" width="100px;"></a>

				</div>
				</div>
				<div class="col-md-2">
				<center><a href="./addStages" class="btn btn-primary">Add Stages</a></center>
				</div>
			</div>
	...
	<!--first form-->
        ...
        <tbody>
           <c:forEach items="${listStages}" var="stages" varStatus="loop">
					<tr id="row_${stages.stage_id}">
					<td>${loop.index+1}</td>
						<td>${stages.stage_name}</td>
						<td class="edit"><a href="editStages?stage_id=${stages.stage_id}"><button type="button" onclick=""
							name='submit' value="submit" class="btn btn-primary">
							<i class='fa fa-pencil-square-o'></i>&nbsp;Edit
						</button></a></td>
						<td class="delete"><button type="button" value="${stages.stage_id}"
											 name='delete_stages' 
