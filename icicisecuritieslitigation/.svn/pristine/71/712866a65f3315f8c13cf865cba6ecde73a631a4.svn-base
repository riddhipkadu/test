...
<body class="login_body">
	...
	<!-- Incorrect Username -->
		...
		<div class="col-md-5 animated flipInY" style="margin-left: 50px;">
			<div class="login">
				<center>
					<img src="images/logo-2.png" height="100px" width="300px">
				</center>
				<div class="devider"></div>

				<sf:form action="./authenticateUser" method="post" onsubmit="return validateForm();" class="form-horizontal" role="form" autocomplete="off">
		...
		<div class="logo_lexcare">
			<center>
				<img src="images/logo-2.png" height="50" width="150">
			</center>
		</div>
