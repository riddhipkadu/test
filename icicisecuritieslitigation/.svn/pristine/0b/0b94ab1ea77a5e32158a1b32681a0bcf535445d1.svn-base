...
<div class="page_cont_padd">
	<div class="page_container">
		<div class="container">
			...
			<!-- End Header -->
			<sf:form class="form-horizontal" commandName="addLitigationRequest" action="./saveLitigationRequest" enctype="multipart/form-data" method="POST">

				<!-- Second Panel -->
					<div class="f_form_content">
					<h2>Add litigation request</h2>
					...
					<div class="col-md-12" style="margin-top: 10px;">
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<select class="form-control" name="req_liti_unit_id" id="req_liti_unit_id">
					...
					<div class="col-md-12" style="margin-top: 10px;">
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<select class="form-control" name="req_liti_function_id" id="req_liti_function_id">
									   <option value="0">--Select--</option>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<div class="input-group date" id="datepicker1"
										data-date-format="MM">
										<input id="req_liti_received_date" name="req_liti_received_date" class="form-control" readonly/><span
						...
						<div class="col-md-8">
							<div class="form-group">
								<label class="control-label col-sm-4" for="sel1">
									By Party(s) : </label>
								<div class="col-sm-8">
									<input id="req_liti_party_by" name="req_liti_party_by" class="form-control"
						...
						<div class="col-md-8">
							<div class="form-group">
								<label class="control-label col-sm-4" for="sel1"> Against
									Party(s): </label>
								<div class="col-sm-8">
									<input id="req_liti_party_against" name="req_liti_party_against" class="form-control"
					...
					<div class="col-md-12" style="margin-top: 10px;">
						<div class="col-md-8">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<textarea id="req_liti_des" name="req_liti_des" rows="4" cols="59" ></textarea>
								</div>
							</div>
						</div>
					</div>
