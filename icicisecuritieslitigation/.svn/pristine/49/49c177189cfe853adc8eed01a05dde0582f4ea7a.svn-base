...
function validateForm() {
        ...
        var exec_contract_internal_contact_name = $('#exec_contract_internal_contact_name').val();
    	...
    	if (exec_contract_internal_contact_name == 0) {
        	 
     		$( "#exec_contract_internal_contact_name" ).attr( "data-placement", "top" );
     		$( "#exec_contract_internal_contact_name" ).attr( "data-content", "Please enter internal contact person." );
     		$('#exec_contract_internal_contact_name').popover('show');
	
            return false;
        }
    	 else
         {
         	$('#exec_contract_internal_contact_name').popover('destroy');
        }
    	...
    	if (exec_contract_date == 0) {
     		...
     		$( "#exec_contract_date" ).attr( "data-content", "Please enter date." );
