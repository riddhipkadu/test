...
<jsp:include page="/WEB-INF/views/header.jsp"></jsp:include>
	...
	<div class="page_container">
		...
		<sf:form class="form-horizontal" role="form" commandName="externalcounsel"
					action="./saveExternalCounsel" onsubmit="return validateForm();"  method="POST">
			
			<div class="col-md-10">
				<div class="header_button">
					<!--<button type="button" class="btn btn-primary" id="wdt_re">Litigation Summary</button>-->
					<h2 style="color: #032BEC; font-size: 24px; float: left;">External Counsels</h2>
				...
				<div class="col-md-12">
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<sf:select class="form-control" path="exte_coun_state_id" id="exte_coun_state_id" name="exte_coun_state_id">
								    <sf:option value="0">--Select--</sf:option>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<sf:select class="form-control"  path="exte_coun_city" id="exte_coun_city" name="exte_coun_city">
					...
					<div class="form-group">
							...
							<div class="col-sm-7">
							<sf:select class="form-control" items="${allLawFirm}" path="exte_coun_law_firm" id="exte_coun_law_firm" name="exte_coun_law_firm">
							   </sf:select><i class="asterisk_input"></i>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<sf:select class="form-control" items="${allAreaOfExpertise}" path="exte_coun_area_of_expertise" id="exte_coun_area_of_expertise"	name="exte_coun_area_of_expertise">
