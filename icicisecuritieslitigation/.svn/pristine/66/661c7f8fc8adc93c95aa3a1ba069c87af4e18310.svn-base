...
<div class="col-md-10">
				<div class="header_button">
					...
					<h2 style="color:#032BEC;font-size:24px;float:left;">Contract Type List</h2>
					<a href="./masters"><img src="images/DashboardIcons/backold.png" class="backButton" width="100px;"></a>

				</div>
				</div>
				<div class="col-md-2">
				<center><a href="./addContractType" class="btn btn-primary">Add Contract Type</a></center>
				</div>
			</div>
	...
	<!--first form-->
        ...
        <tbody>
          <c:forEach items="${listContractType}" var="contract" varStatus="loop">
					<tr id="row_${contract.cont_type_id}">
						<td>${loop.index+1 }</td>
						<td>${contract.cont_type_name}</td>
						<td class="edit"><a href="editContractType?cont_type_id=${contract.cont_type_id}"><button type="button" onclick=""
							name='submit' value="submit" class="btn btn-primary">
							<i class='fa fa-pencil-square-o'></i>&nbsp;Edit
						</button></a></td>
						
						<td class="delete"><button type="button" value="${contract.cont_type_id}"
											 name='delete_cont_type' 
